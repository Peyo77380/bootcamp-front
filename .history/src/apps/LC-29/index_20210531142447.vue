                ...
                <tr v-for="list in lists" :key="list.id">
                  ...
                  <td class="text-center">
                    <b-button
                      ...
                      ><i class="pe-7s-trash btn-icon-wrapper"> > </i></b-button
                    >
                  </td>
                  <b-table :list="lists" striped responsive="sm">
                    <template #cell(show_details)="row">
                      <b-button size="sm" @click="row.toggleVoir" class="mr-2">
                      ...
                      <b-card>
                        <b-row class="mb-2">
                          <b-col sm="3" class="text-sm-right"
                            ><b>Age:</b></b-col
                          >
                          <b-col>{{ row.list.createdAt }}</b-col>
                          <b-col sm="3" class="text-sm-right"
                            ><b>Adresse:</b></b-col
                          >
