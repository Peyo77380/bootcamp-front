              ...
              <tbody>
                <tr v-for="list in lists" :key="list.id">
                  ...
                  <td class="text-center">
                    ...
                    ><b-tooltip target="exButton1" placement="top" title="Tooltip on top"class="mb-2 btn-icon btn-icon-only btn-pill"
                      variant="outline-info"
                      @click="edit(list.id)"
                      ><i class="pe-7s-pen btn-icon-wrapper"> </i></b-tooltip></b-button>
