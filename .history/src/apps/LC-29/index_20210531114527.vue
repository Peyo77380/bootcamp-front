              ...
              <tbody>
                <tr v-for="list in lists" :key="list.id">
                  ...
                  <td class="text-center">
                    ...
                    <div class="category" v-if="toggleVoir" transition="expand">
                      <li class="text-center">{{ list.modify }}</li>
                      <li class="text-center">{{ list.createdAt }}</li>
                    </div>
                  </td>
                </tr>
              </tbody>
...
export default {
  ...
  methods: {
    ...
    toggleVoirPlus: function(){
      this.toggleVoir = !this.toggleCat;
    },
    getStatus(category) {
      switch (category) {
        case "activité":
