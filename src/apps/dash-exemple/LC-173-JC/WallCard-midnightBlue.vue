    ...
    <b-container class="text-eternity">
        ...
        <b-row align-h="between" class="wallCard-header">
            <b-form-radio-group
                ...
                button-variant="outline-midnightBlue"
                size="sm"
            ...
            <b-input-group class="col col-5 wallCard-header-search">
                ...
                <b-input-group-append>
                    <b-button class="btn-search btn-midnightBlue">
            ...
            <b-button-group size="sm" class="row m-0" align-content="end">
                <b-dropdown right text="Statut" variant="midnightBlue">
                    <b-dropdown-item>Item 1</b-dropdown-item>
                    <b-dropdown-item>Item 2</b-dropdown-item>
                    <b-dropdown-divider></b-dropdown-divider>
                    <b-dropdown-item>Item 3</b-dropdown-item>
                </b-dropdown>
                <b-dropdown right text="Catégorie" variant="midnightBlue">
                    <b-dropdown-item>Item 1</b-dropdown-item>
                    <b-dropdown-item>Item 2</b-dropdown-item>
                    <b-dropdown-divider></b-dropdown-divider>
                    <b-dropdown-item>Item 3</b-dropdown-item>
                </b-dropdown>
                <b-dropdown right text="Type d'adhésion" variant="midnightBlue">
                    <b-dropdown-item>Item 1</b-dropdown-item>
                    <b-dropdown-item>Item 2</b-dropdown-item>
                    <b-dropdown-divider></b-dropdown-divider>
                    <b-dropdown-item>Item 3</b-dropdown-item>
                </b-dropdown>
                <b-dropdown right text="Tri" variant="midnightBlue">
                    <b-dropdown-item>Item 1</b-dropdown-item>
                    <b-dropdown-item>Item 2</b-dropdown-item>
                    <b-dropdown-divider></b-dropdown-divider>
                    <b-dropdown-item>Item 3</b-dropdown-item>
...
<script>
import Card2 from '@/apps/dash-exemple/LC-173-JC/components/Card-midnightBlue';
...
export default {
    ...
    data() {
        return {
            ...
            search  : '<b-icon icon=\'search\' aria-hidden=\'true\'></b-icon>',
            selected: 'radio1',
            options : [
                { text: 'Membres', value: 'radio1' },
                { text: 'Sociétés', value: 'radio2' }
            ]
        };
    }
};
