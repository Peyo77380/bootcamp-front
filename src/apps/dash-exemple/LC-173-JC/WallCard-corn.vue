        ...
        <b-row align-h="between" class="wallCard-header">
            ...
            <b-input-group class="col col-5 wallCard-header-search">
                ...
                <b-input-group-append>
                    <b-button class="btn-search btn-corn">
            ...
            <b-button-group size="sm" class="row m-0" align-content="end">
                <b-dropdown right text="Statut" variant="corn">
                    <b-dropdown-item>Item 1</b-dropdown-item>
                    <b-dropdown-item>Item 2</b-dropdown-item>
                    <b-dropdown-divider></b-dropdown-divider>
                    <b-dropdown-item>Item 3</b-dropdown-item>
                </b-dropdown>
                <b-dropdown right text="Catégorie" variant="corn">
                    <b-dropdown-item>Item 1</b-dropdown-item>
                    <b-dropdown-item>Item 2</b-dropdown-item>
                    <b-dropdown-divider></b-dropdown-divider>
                    <b-dropdown-item>Item 3</b-dropdown-item>
                </b-dropdown>
                <b-dropdown right text="Type d'adhésion" variant="corn">
                    <b-dropdown-item>Item 1</b-dropdown-item>
                    <b-dropdown-item>Item 2</b-dropdown-item>
                    <b-dropdown-divider></b-dropdown-divider>
                    <b-dropdown-item>Item 3</b-dropdown-item>
                </b-dropdown>
                <b-dropdown right text="Tri" variant="corn">
                    <b-dropdown-item>Item 1</b-dropdown-item>
                    <b-dropdown-item>Item 2</b-dropdown-item>
                    <b-dropdown-divider></b-dropdown-divider>
                    <b-dropdown-item>Item 3</b-dropdown-item>
...
<script>
import Card2 from '@/apps/dash-exemple/LC-173-JC/components/Card-corn.vue';
