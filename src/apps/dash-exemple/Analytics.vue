    ...
    <div>
        ...
        <div class="mb-3 card">
            <div class="card-header-tab card-header">
                ...
                >
                    <i
                        class="header-icon lnr-charts icon-gradient bg-happy-green"
                    >
                    </i>
            ...
            <div class="no-gutters row">
                <div class="col-sm-6 col-md-4 col-xl-4">
                    ...
                    >
                        <div class="icon-wrapper rounded-circle">
                            <div
                                class="icon-wrapper-bg opacity-10 bg-warning"
                            ></div>
                ...
                <div class="col-sm-6 col-md-4 col-xl-4">
                    ...
                    >
                        <div class="icon-wrapper rounded-circle">
                            <div
                                class="icon-wrapper-bg opacity-9 bg-danger"
                            ></div>
                ...
                <div class="col-sm-12 col-md-4 col-xl-4">
                    ...
                    >
                        <div class="icon-wrapper rounded-circle">
                            <div
                                class="icon-wrapper-bg opacity-9 bg-success"
                            ></div>
                                        ...
                                        >
                                            ...
                                            <div class="widget-numbers">
                                                <div class="widget-chart-flex">
                                                    <div>
                                                        <span
                                                            class="opacity-10 text-success pr-2"
                                                        >
                                                            <font-awesome-icon
                                                                icon="angle-up"
                                                            />
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card-hover-shadow-2x mb-3 card">
                    <div class="card-header-tab card-header">
                        ...
                        >
                            <i
                                class="header-icon lnr-lighter icon-gradient bg-amy-crisp"
                            >
                            </i>
                            Timeline Example
                        </div>
                        ...
                        <VuePerfectScrollbar class="scrollbar-container" v-once>
                            <div class="p-4">
                                ...
                                >
                                    ...
                                    <div
                                        class="dot-warning vertical-timeline-element"
                                    >
                                        <div>
                                            <span
                                                class="vertical-timeline-element-icon bounce-in"
                                    ...
                                    <div
                                        class="dot-dark vertical-timeline-element"
                                    >
                                        <div>
                                            <span
                                                class="vertical-timeline-element-icon bounce-in"
                    ...
                    <div class="d-block text-center card-footer">
                        <button
                            class="btn-shadow btn-wide btn-pill btn btn-focus"
                        >
                            <span
                                class="badge badge-dot badge-dot-lg badge-warning badge-pulse"
                                >Badge</span
                            >
                            View All Messages
                        </button>
            ...
            <div class="col-md-6 col-xl-3">
                ...
                >
                    <div class="widget-chat-wrapper-outer">
                        ...
                        <div
                            class="no-gutters widget-chart-wrapper mt-3 mb-3 pl-0 he-auto row"
                        >
                            <div class="col-md-12">
                                <trend
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card-hover-shadow-2x mb-3 card">
                    <div class="card-header-tab card-header">
                        ...
                        >
                            <i
                                class="header-icon lnr-database icon-gradient bg-malibu-beach"
                            >
                            </i
                            >Tasks List
                        </div>
                        ...
                        <VuePerfectScrollbar class="scrollbar-container" v-once>
                            ...
                            >
                                <li class="list-group-item">
                                    <div
                                        class="todo-indicator bg-warning"
                                    ></div>
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div
                                ...
                                <li class="list-group-item">
                                    <div
                                        class="todo-indicator bg-success"
                                    ></div>
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card-hover-shadow-2x mb-3 card">
                    <div class="card-header-tab card-header">
                        ...
                        >
                            <i
                                class="header-icon lnr-printer icon-gradient bg-ripe-malin"
                            >
                            </i>
                            Chat Box
                        </div>
                            ...
                            <div class="chat-wrapper p-1">
                                <div class="chat-box-wrapper">
                                    <div>
                                        <div class="avatar-icon-wrapper mr-1">
                                            ...
                                            ></div>
                                            <div
                                                class="avatar-icon avatar-icon-lg rounded"
                                            >
                                                <img
                                                    src="@/assets/images/avatars/2.jpg"
                                                    alt=""
                                ...
                                <div class="float-right">
                                    ...
                                    >
                                        ...
                                        <div>
                                            <div
                                                class="avatar-icon-wrapper ml-1"
                                            >
                                                <div
                                                    class="badge badge-bottom btn-shine badge-success badge-dot badge-dot-lg"
                                                ></div>
...
import chart1 from "@/apps/dash-exemple/Analytics/chart1";
import chart2 from "@/apps/dash-exemple/Analytics/chart2";
import chart3 from "@/apps/dash-exemple/Analytics/chart3";
