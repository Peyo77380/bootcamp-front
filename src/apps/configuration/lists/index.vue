              ...
              >
                ...
                <div>
                  ...
                  <button
                    ...
                    disabled
                  >
                    <country-flag country="US" size="small" class="mr-1" /><span
                      >Anglais</span
                    >
                  </button>
                  <button
            ...
            <v-tab-item v-for="i in items" :key="i._id">
              <div class="table-responsive">
                ...
                >
                  ...
                  <tbody>
                    <tr v-for="list in filteredItems" :key="list.id">
                      <td
                      ...
                      >
                        <div
                          ...
                          :class="getClass(list.section)"
                        >
                          {{ getCategoryInitial(list.section) }}
                        </div>
                      </td>
                      <td class="text-center">
                        <b-btn id="exButton4" variant="outiline-info">
                          {{ list.key }}
                          <b-tooltip
                            target="exButton4"
                      ...
                      <td class="text-center">
                        <b-button
                          ...
                          :to="{
                            path: `/configuration/lists/${list._id}`,
                          }"
  ...
  computed: {
    filteredItems: function () {
      ...
      if (category === "Toutes les catégories" || category === null) {
        ...
        return vm.lists.filter(function (list) {
          return list.section === category;
        });
      }
    },
    prows() {
  ...
  methods: {
    ...
    async loadLists() {
      try {
        ...
        this.lists = res.datas.data.datas;
      } catch (error) {
        console.error(error);
      }
    },
