    ...
    <div class="mb-5" v-if="loading == false">
      <v-flex xs12 sm8 offset-sm1 align-center justify-center>
        <v-form ref="form">
          ...
          <v-layout>
            <v-text-field v-model="formItem.name" label="Nom"></v-text-field>
          ...
          >
            <h5>
              Historique des Prix
              <font-awesome-icon icon="chevron-up" v-if="isShow" />
              <font-awesome-icon icon="chevron-down" v-if="!isShow" />
            </h5>
              ...
              >
                <thead>
                  <tr>
                    ...
                    <th class="text-center">Prix membres</th>
                    <th class="text-center">Prix co</th>
                  </tr>
                </thead>
                <tbody>
                  <template>
                    <tr v-for="price in formItem.prices" :key="price._id">
                      <td class="text-center">
                        {{ getFormattedDate(price.startDate) }}
                      </td>
                      <td class="text-center">
          ...
          <v-btn color="success" @click="confirmer"> Confirmer </v-btn>
...
export default {
  ...
  async mounted() {
    ...
    this.selectedCategories = this.categoriesCombined[this.formItem.type - 1];
