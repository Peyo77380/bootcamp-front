                    ...
                    <div class="m-3 mb-3">
                        ...
                        <b-form>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <b-form-group
                                        label="Niveau où se situe la salle :"
                                        class="text-left"
                                    >
                                        <b-form-select
                                            v-model="room.floor"
                                ...
                                <div class="col-7">
                                    <div class="table-responsive">
                                        <table
                                            class="align-middle mb-5 table table-border table-striped table-hover"
                                        >
                                            <thead>
                                                <tr>
                                                    <th
                                            ...
                                            <tbody>
                                                <tr
                                                    v-for="openingHoursDetail in openingHoursDetailsData"
                                                    :key="openingHoursDetail.id"
                                                >
                                                    <td
                                                        class="text-center text-muted border"
                                                    >
                                                        {{
                                                            openingHoursDetail.name
                                                        }}
                                                    </td>
                                                    <td
                                                        class="text-center border"
                                                    >
                                                        <div class="row ml-1">
                                                            ...
                                                            <b-form-input
                                                                v-model="
                                                                    openingHoursDetail.startMinutes
                                                                "
                                                                class="inputRoom text-center border col-3"
                                                                type="number"
                                                                min="0"
...
import {
    ...
    MinRentalDurations,
    TypeBookings
} from "@/apps/tomerge/lc-142/Components/data-roomDetails";
